...
A aplicação pode ser acessada através do seguinte endereço:

https://mysongprofileappv2.onrender.com

## Backend

A API pode ser acessada através do seguinte endereço:
...
## Swagger Não Implementado Corretamente

É possível acessar a página do Swagger ao adicionar:

```text
/swagger
```

ao endereço do backend.

Exemplo:

```text
https://t2-inf1407-2026-back.onrender.com/swagger
```

Entretanto, o Swagger não está funcionando como esperado.

A funcionalidade de execução de testes diretamente pela interface está retornando respostas inesperadas para determinados endpoints, principalmente aqueles protegidos por autenticação.

Por esse motivo, recomenda-se utilizar o frontend da aplicação para testar as funcionalidades implementadas.

---

# 📅 Observações Sobre o Desenvolvimento

Houve problemas durante o desenvolvimento que exigiram a recriação dos repositórios.

Foi necessário:

- Recriar o repositório do frontend duas vezes;
- Recriar o repositório do backend uma vez.

Como comprovação da evolução do projeto, abaixo estão os registros dos commits dos repositórios antigos.

## Histórico de Commits - Frontend
